...
BOOST_AUTO_TEST_CASE( encode_check_magic_values )
{
  ...
  unsigned center_index = (uint16_cube_of_8::axis_length*uint16_cube_of_8::axis_length);
  center_index *= (uint16_cube_of_8::axis_length-1)/2;//center of z
  
  center_index += (uint16_cube_of_8::axis_length-1)/2*uint16_cube_of_8::axis_length; //center of y
  center_index += (uint16_cube_of_8::axis_length-1)/2;//center of x
