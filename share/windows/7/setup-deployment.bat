...
:: without FFMEPG
:: SET "Path variable
set "PATH=%ZIP_BIN%;%CMAKE_BIN%;%GRADLE_BIN%;%CURL_BIN%;%TIFF_BIN%;%HDF5_BIN%;%LZ4_BIN%;%PATH%"

:: SET "BIN variable
set "LIB=%BOOST_LIB%;%TIFF_LIB%;%HDF5_LIB%;%LZ4_LIB%;%LIB%"

:: SET "INCLUDE variable
set "INCLUDE=%BOOST_INCLUDE%;%TIFF_INCLUDE%;%HDF5_INCLUDE%;%LZ4_INCLUDE%;%INLUDE%"

:: SET "CMAKE_PREFIX_PATH variable to make find_package calls happy
set "CMAKE_PREFIX_PATH=%BOOST_ROOT%;%TIFF_ROOT%;%HDF5_ROOT%;%LZ4_ROOT%"
