#define __BENCHMARK_FLATTEN_TO_NEIGHBORHOOD_SCHEME_IMPL_CPP__

/*
  notes/TODOs:
  - not sure if totally random or the sin data set is appropriate for the flatten_to_neighborhood scheme
...
BENCHMARK_DEFINE_F(static_default_fixture, one_thread)(benchmark::State& state) {
  ...
  sqeazy::flatten_to_neighborhood_scheme<std::uint16_t> local;
