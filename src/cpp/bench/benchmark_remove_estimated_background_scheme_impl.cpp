#define __BENCHMARK_REMOVE_ESTIMATED_BACKGROUND_SCHEME_IMPL_CPP__

/*
  notes/TODOs:
  - not sure if totally random or the sin data set is appropriate for the remove_estimated_background scheme
