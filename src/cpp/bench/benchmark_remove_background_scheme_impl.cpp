#define __BENCHMARK_REMOVE_BACKGROUND_SCHEME_IMPL_CPP__

/*
  notes/TODOs:
  - not sure if totally random or the sin data set is appropriate for the remove_background scheme

*/

#include <thread>

#include "encoders/remove_background_scheme_impl.hpp"
...
BENCHMARK_DEFINE_F(static_default_fixture, one_thread)(benchmark::State& state) {
  ...
  sqeazy::remove_background_scheme<std::uint16_t> local;
