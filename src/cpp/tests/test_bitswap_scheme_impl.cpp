...
struct incrementing_array
{
    ...
    output(len,0)
  {
    ...
    //bitswap2
    plane2_encoded_by_hand[12] = 0x55;
    plane2_encoded_by_hand[13] = 0xaaff;
    plane2_encoded_by_hand[14] = 0x1b1b;
    plane2_encoded_by_hand[15] = plane2_encoded_by_hand[14];

    //bitswap4
    plane4_encoded_by_hand[12] = 0x123;
    plane4_encoded_by_hand[13] = 0x4567;
    plane4_encoded_by_hand[14] = 0x89ab;
    plane4_encoded_by_hand[15] = 0xcdef;
