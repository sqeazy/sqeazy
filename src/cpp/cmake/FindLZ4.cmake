...
if(IS_DIRECTORY ${LZ4_ROOT})
  ...
  IF(WIN32)
	find_library(LZ4_LIB_PATH NAMES lz4 liblz4 liblz4.dll.a liblz4.a lz4.a liblz4.dll NAMES_PER_DIR HINTS ${LZ4_ROOT} PATHS ${LZ4_ROOT} PATH_SUFFIXES lib bin NO_DEFAULT_PATH)
	IF(NOT LZ4_LIB_PATH)
		FILE(GLOB REC_PATHS ${LZ4_ROOT}/bin/liblz4* ${LZ4_ROOT}/liblz4* ${LZ4_ROOT}/lib/liblz4* )
