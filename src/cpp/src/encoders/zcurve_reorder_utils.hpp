#ifndef _MEMORY_ZCURVE_UTILS_H_
#define _MEMORY_ZCURVE_UTILS_H_
...
namespace sqeazy {
  ...
  namespace detail {
	...
	for(shape_value_t & n_tiles : shape_in_tiles )
	  n_tiles = n_tiles / common;
